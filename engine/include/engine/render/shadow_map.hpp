...
/// Manages all shadow maps for the scene
class ShadowSystem {
public:
    static ShadowSystem& get_instance();

    /// Initialize all shadow resources (call once after GL context ready)
    void initialize();
    ...
    /// @param start_texture_unit First texture unit to use (default 5, after material textures)
