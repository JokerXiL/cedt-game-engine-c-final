...
Renderer::Renderer()
    ...
    // Create meshes
    _cube_mesh = mesh_factory::create_cube(1.0f);
    _ground_mesh = mesh_factory::create_plane(100.0f, 100.0f);

    // Create materials with different colors
    // Player: blue material (albedo = 0.2, 0.4, 0.8)
    _player_material = std::make_unique<StandardMaterial>(
    ...
    _ground_material = std::make_unique<StandardMaterial>(
